...
function printHelp(): void {
  console.log(`
oh-my-groundcontrol installer

Usage: bunx oh-my-groundcontrol install [OPTIONS]
       bunx oh-my-groundcontrol models [OPTIONS]
...
Examples:
  bunx oh-my-groundcontrol install
  bunx oh-my-groundcontrol models
  bunx oh-my-groundcontrol install --no-tui --kimi=yes --openai=yes --anthropic=yes --copilot=no --zai-plan=no --antigravity=yes --chutes=no --opencode-free=yes --balanced-spend=yes --opencode-free-model=auto --aa-key=YOUR_AA_KEY --openrouter-key=YOUR_OR_KEY --tmux=no --skills=yes
`);
}
