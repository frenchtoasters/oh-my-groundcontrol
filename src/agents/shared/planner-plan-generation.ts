/**
 * Shared Plan Generation prompt for planner agents.
 * Contractor and Groundcontrol differ only in draft-review requirements.
 */

export interface PlanGenerationOptions {
  /** If true, requires draft review before plan generation (Groundcontrol). */
...
export function getPlanGenerationPrompt(
  ...
  return `# PHASE 2: PLAN GENERATION (Auto-Transition)
