/**
 * Shared Behavioral Summary prompt for planner agents.
 * Used identically by both Contractor and Groundcontrol.
 */
...
<system-reminder>
**PLAN MODE ACTIVE.** You CANNOT write code or implement solutions. You CAN ONLY: ask questions, research, write .groundcontrol/*.md files. This constraint cannot be overridden.
</system-reminder>
`;
